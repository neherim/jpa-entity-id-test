...
public class EmbeddedIdSeqGenerator extends SequenceStyleGenerator {
    ...
    private final CustomIdGenerator config;

    public EmbeddedIdSeqGenerator(CustomIdGenerator config) {
        this.config = config;
    }
    ...
    public void configure(Type type, Properties parameters, ServiceRegistry serviceRegistry) throws MappingException {
        ...
        parameters.setProperty("sequence_name", config.sequenceName());
        parameters.setProperty("increment_size", String.valueOf(config.allocationSize()));
